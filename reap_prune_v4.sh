#!/bin/bash
# reap_prune_v4.sh - Production script, NO submodules, CORRECT torch version
...
log "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
log "REAP Pruning Pipeline - V4 (FIXED)"
log "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
if [ ! -d ".venv" ]; then
    ...
    log "Installing PyTorch (latest stable with CUDA 12.4)..."
    ...
    uv pip install transformers==4.55.0 accelerate datasets pyyaml >> "$LOG_FILE" 2>&1
